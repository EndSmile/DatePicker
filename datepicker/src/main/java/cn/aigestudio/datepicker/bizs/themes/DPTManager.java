...
public final class DPTManager {
    ...
    /**
     * @see DPTheme#colorBgToday()
     */
    public int colorBgToday() {
        return theme.colorBgToday();
    }

    /**
     * @see DPTheme#colorTextToday()
     */
    public int colorTextToday() {
        return theme.colorTextToday();
    }
    ...
    /**
     * @see DPTheme#colorDisEnableDay()
     */
    public int colorDisEnableDay() {
        return theme.colorDisEnableDay();
    }
