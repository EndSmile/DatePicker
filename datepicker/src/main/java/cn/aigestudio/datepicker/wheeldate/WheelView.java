...
public class WheelView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray attribute = context.obtainStyledAttributes(attrs,
                R.styleable.datepicker_WheelView);
        unitHeight = (int) attribute.getDimension(
                R.styleable.datepicker_WheelView_unitHight, 32);
        normalFont = attribute.getDimension(
                R.styleable.datepicker_WheelView_normalTextSize, 14.0f);
        selectedFont = attribute.getDimension(
                R.styleable.datepicker_WheelView_selectedTextSize, 22.0f);
        itemNumber = attribute.getInt(R.styleable.datepicker_WheelView_itemNumber, 7);
        normalColor = attribute.getColor(
                R.styleable.datepicker_WheelView_normalTextColor, 0xff000000);
        selectedColor = attribute.getColor(
                R.styleable.datepicker_WheelView_selectedTextColor, 0xffff0000);
        lineColor = attribute.getColor(R.styleable.datepicker_WheelView_lineColor_,
                0xff000000);
        bottomLineColor = attribute.getColor(R.styleable.datepicker_WheelView_bottomLineColor,
                0xffDADADA);
        lineWidth = attribute.getDimension(R.styleable.datepicker_WheelView_lineHeight, 2f);
        firstLineAndSecondLineSpace = attribute.getDimension(R.styleable.datepicker_WheelView_firstLineAndSecondLineSpace, 40f);
        maskHight = attribute.getDimension(R.styleable.datepicker_WheelView_maskHight,
                48.0f);
        noEmpty = attribute.getBoolean(R.styleable.datepicker_WheelView_noEmpty, true);
        isEnable = attribute
                .getBoolean(R.styleable.datepicker_WheelView_isEnable, true);
        attribute.recycle();
    ...
    public void setDefault(String string){
        for (int i=0;i<itemList.size();i++){
            if (itemList.get(i).itemText.equals(string)){
                setDefault(i);
            }
        }
    }
